...
export class LstmPlaygroundComponent {
  ...
  updateForget(val: number): void { this.biasForget.set(val); }
  updateInput(val: number): void { this.biasInput.set(val); }
  updateOutput(val: number): void { this.biasOutput.set(val); }
  updateXt1(val: number): void { this.xt1.set(val); }
  updateXt2(val: number): void { this.xt2.set(val); }
  updateXt3(val: number): void { this.xt3.set(val); }
  updatePrevHidden(val: number): void { this.prevHidden.set(val); }
  updatePrevCell(val: number): void { this.prevCell.set(val); }
}
