    ...
    (window as any).runDiagnostics = () => {
      ...
      const report = {
        ...
        clientMetrics: {
          ...
          activeMode: document.documentElement.classList.contains('mode-research') ? 'RESEARCH_FELLOW' : 'SYSTEM_ARCHITECT',
      ...
      console.log(`%c[SYSTEM_OK] David Sandoval Kernel Active`, "color: #34d399; font-weight: bold; font-size: 12px;");
